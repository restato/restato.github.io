...
This guide builds a vendor-neutral reference architecture for that pattern. It does not require Palantir, a graph database, or OWL. The first two articles in this series cover the strategic case and Palantir's integrated implementation. The [graph database and ontology guide](/blog/ai-engineer-graph-databases-ontology/) covers the underlying graph and semantic-web concepts.
