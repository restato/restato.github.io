...
Vercel은 [2026년 7월 22일 installable eve extension을 발표했습니다](https://vercel.com/changelog/eve-extensions). 공개 eve changelog는 mounted extension과 그 ownership·peer-range contract를 0.22.4에 기록하고, 전용 `eve extension init`과 `eve extension build` command는 0.22.5에 추가합니다. 8월 5일 조사 cutoff에서 npm은 eve 0.30.8을 표시했고 mounted extension은 계속 지원됐습니다.
